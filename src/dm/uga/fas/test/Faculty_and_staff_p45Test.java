...
public class Faculty_and_staff_p45Test {
	...
	public void test() {
		...
		assertEquals("C1U1-middlename", "A", fas.get(0).getMiddlename());
		...
		assertEquals("C1U1A1-street_2", "3803 Smithonia Rd", address.get(0).getStreet_2());
		assertEquals("C1U1A1-city", "Comer", address.get(0).getCity());
		assertEquals("C1U1A1-state", "GA", address.get(0).getState());
		assertEquals("C1U1A1-zip", "30629", address.get(0).getZip());
		assertEquals("C1U1A1-zip_4", "", address.get(0).getZip_4());
		assertEquals("C1U1A1-country", "", address.get(0).getCountry());
		phone = address.get(0).getPhone();
		assertEquals("C1U1A1-country_code", "", phone.getCountry_code());
		assertEquals("C1U1A1-area_code", "", phone.getArea_code());
		assertEquals("C1U1A1-exchange_code", "743", phone.getExchange_code());
		assertEquals("C1U1A1-line_number", "5487", phone.getLine_number());
		assertEquals("C1U1A1-extension", "", phone.getExtension());
